...
export default async function SpecificForum({
  ...
  return (
    <div className="flex h-full flex-col items-start">
      ...
      <section className="scrollbar-hide mb-6 flex h-[60vh] w-[95vw] flex-col overflow-y-auto rounded-md border border-black bg-[#A5A5A5] bg-opacity-[75%] md:w-[80vw] landscape-lg:h-[80vh] landscape-xl:h-[80vh]">
            ...
            >
              <Link href={`/forum/${forum._id}/${forum._id}`}>
                <div className="flex h-[50%] w-full flex-col justify-start p-2">
                  <h2 className="text-stroke-p text-md landscape-md:text-md font-notojp font-bold text-white text-shadow-xl sm:text-sm md:text-xl lg:text-3xl xl:text-2xl landscape-sm:text-sm landscape-lg:text-xl landscape-xl:text-2xl">
                    {forum.title}
                  </h2>
                  <p className="text-stroke md:text-md font-notojp text-xs text-white text-shadow-xl sm:text-xs lg:text-2xl xl:text-xl landscape-sm:text-sm landscape-lg:text-sm landscape-xl:text-lg">
              ...
              <div className="flex h-[50%] w-full flex-row items-center justify-evenly">
                <p className="text-stroke md:text-md font-notojp text-xxs text-white text-shadow-xl sm:text-xs lg:text-xl xl:text-lg landscape-sm:mt-2 landscape-sm:text-xs landscape-lg:text-sm landscape-xl:mt-4 landscape-xl:text-lg">
                  By: {forum.by}
                </p>
                <p className="text-stroke md:text-md font-notojp text-xxs text-white text-shadow-xl sm:text-xs lg:text-xl xl:text-lg landscape-sm:mt-2 landscape-sm:text-xs landscape-lg:text-sm landscape-xl:mt-4 landscape-xl:text-lg">
                ...
                <p className="text-stroke md:text-md font-notojp text-xxs text-white text-shadow-xl sm:text-xs lg:text-xl xl:text-lg landscape-sm:mt-2 landscape-sm:text-xs landscape-lg:text-sm landscape-xl:mt-4 landscape-xl:text-lg">
                  Latest Reply:{' '}
                  {forum.updatedAt ? formatDateSmall(forum.updatedAt) : ''}
                </p>
              </div>
            </li>
          ))}
