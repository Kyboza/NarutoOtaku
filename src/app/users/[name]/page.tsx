...
import { getUserFromToken } from '@/app/actions/userActions';
  ...
  return (
    <div className="flex flex-col items-center px-4">
      ...
      <section className="flex flex-col md:flex-row w-full max-w-[90vw] mt-6 bg-[#A5A5A5] bg-opacity-75 border border-black rounded-md overflow-hidden shadow-sm">
        ...
        {user.username !== currentUser ? ( <button className="w-28 h-10 border border-black text-sm md:text-base font-notojp text-white hover:cursor-pointer mb-2">Follow+</button>) : (
          null
          )}
